...
EvaluatePredictionsReport <- function(
  ...
  # ================================================================
  # SECTION: Package guard (official)
  # ================================================================
  ...
  # ================================================================
  # SECTION: Setup paths (KEEP EXACTLY AS YOU SET)
  # ================================================================
  artifacts_root <- ddesonn_artifacts_root(output_root)
  reports_dir <- file.path(artifacts_root, "reports")
  
  # FIX: ONLY create EvaluatePredictionsReportPlots under <output_root>/R/reports
  ...
  plot_dir <- file.path(reports_dir, "EvaluatePredictionsReportPlots")
  ...
  if (isTRUE(verbose)) {
    ...
    if (dir.exists(legacy_plot_dir))
      cat("[Eval] legacy_plot_dir detected (read-only):", legacy_plot_dir, "\n")
  }
  ...
  # ================================================================
  # SECTION: Safety defaults (official)
  # ================================================================
  ...
  # ================================================================
  # SECTION: Inspect predictions/errors (optional) (official)
  # ================================================================
  ...
  # ================================================================
  # SECTION: weights summary (robust) (official)
  # ================================================================
  if (isTRUE(ML_NN)) {
  ...
  # ================================================================
  # SECTION: Select evaluation data (official)
  # ================================================================
  ...
  # ================================================================
  # SECTION: Mode inference (official)
  # ================================================================
  ...
  # ================================================================
  # SECTION: Regression branch (official)
  # ================================================================
  ...
  # ================================================================
  # SECTION: Binary branch (official, no helpers)
  # ================================================================
  ...
  # ================================================================
  # SECTION: Multiclass branch (official)
  # ================================================================
