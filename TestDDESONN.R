...
# do_ensemble         <- FALSE
# num_networks        <- 2L          # e.g., run 5 models in one DDESONN instance
...
# num_temp_iterations <- 3L          # MAIN + 1 TEMP pass (set higher for more TEMP passes)
#
...
if(train) {
  ...
  if (!isTRUE(do_ensemble)) {
    ...
    ## Run folder (matches your screenshot)
